...
int main()
{
    ...
    VkResult result = vkEnumeratePhysicalDevices(instance.GetInstance(), &device_count, nullptr);
    ...
    result = vkEnumeratePhysicalDevices(instance.GetInstance(), &device_count, physical_devices.data());
    if(result != VK_SUCCESS)
    {
